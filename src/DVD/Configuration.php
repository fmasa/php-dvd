...
class Configuration
{
     ...
     *
     * @see \DVD\LibraryHooks\LibraryHook
    ...
    private $availableLibraryHooks = array(
        'stream_wrapper' => 'DVD\LibraryHooks\StreamWrapperHook',
        'curl'           => 'DVD\LibraryHooks\CurlHook',
        'soap'           => 'DVD\LibraryHooks\SoapHook',
    );
    ...
    private $availableStorages = array(
        'blackhole' => 'DVD\Storage\Blackhole',
        'json'      => 'DVD\Storage\Json',
        'yaml'      => 'DVD\Storage\Yaml',
    );
    ...
    private $availableRequestMatchers = array(
        'method'       => array('DVD\RequestMatcher', 'matchMethod'),
        'url'          => array('DVD\RequestMatcher', 'matchUrl'),
        'host'         => array('DVD\RequestMatcher', 'matchHost'),
        'headers'      => array('DVD\RequestMatcher', 'matchHeaders'),
        'body'         => array('DVD\RequestMatcher', 'matchBody'),
        'post_fields'  => array('DVD\RequestMatcher', 'matchPostFields'),
        'query_string' => array('DVD\RequestMatcher', 'matchQueryString'),
    );
     ...
     *
     * Files in this path are left as is. Blacklisting PHP-DVDs own paths is necessary
     * to avoid infinite loops.
     *
     * @var array A blacklist is a list of paths.
     */
    private $blackList = array('src/DVD/LibraryHooks/', 'src/DVD/Util/SoapClient', 'tests/DVD/Filter');
     ...
     */
    private $mode = DVD::MODE_NEW_EPISODES;
     ...
     *
     * @return Configuration
     * @throws DVDException If provided cassette path is invalid.
     */
     ...
     *
     * Objects are created in the DVDFactory.
     *
     ...
     *
     * @return Configuration
     * @throws DVDException If specified parameters are invalid.
     */
     ...
     *
     * @return $this
     * @throws DVDException If a invalid storage name is given.
     */
     ...
     *
     * @param string $mode The mode to set DVD to
     *
     * @return Configuration
     */
     ...
     * @throws DVDException If cassette path is invalid.
     */
