...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMatches()
    {
        ...
        $this->assertTrue($this->request->matches($request, array(array(RequestMatcher::class, 'matchMethod'))));
    }
    ...
    public function testDoesntMatch()
    {
        ...
        $this->assertFalse($this->request->matches($request, array(array(RequestMatcher::class, 'matchMethod'))));
    }
    ...
    public function testMatchesBody()
    {
        ...
        $this->assertTrue(
            $this->request->matches(
                ...
                array(array(RequestMatcher::class, 'matchBody'))
            )
        );
    }
